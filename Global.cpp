...
void Global::Begin()
{
    ...
    // Display, KNX und Schlüsselschalter initialisieren
    Disp.Begin();
    Knx.Begin();
    ...
    // FOH Licht mit Funktion versehen
    ...
    // Informationstaste mit Funktion versehen
