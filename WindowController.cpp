...
void WindowController::Begin()
{
    ...
    // Fenster- und Jalousieauswahltasten initialisieren
    Windows->ForEach([this](KnxObjectData* obj)
    {
        ...
        // Positionsrückmeldung über Farben
...
void WindowController::AddWindow(const byte MoveKnxObjectIndex, const byte StepKnxObjectIndex,
    const byte UpTriggerKnxObjectIndex, const byte DownTriggerKnxObjectIndex,
    const __FlashStringHelper* Name, NkkKey* Key, Delegate<bool>* CanActivate)
{
...
void WindowController::AddJalousie(const byte MoveKnxObjectIndex, const byte StepKnxObjectIndex,
    const byte UpTriggerKnxObjectIndex, const byte DownTriggerKnxObjectIndex,
    const __FlashStringHelper* Name,
    NkkKey* Key, Delegate<bool>* CanActivate)
{
    // Wrapper für einfacheren Code in der Main.cpp
