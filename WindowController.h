...
public:
    ...
    void AddWindow(const byte MoveKnxObjectIndex, const byte StepKnxObjectIndex,
    ...
    void AddJalousie(const byte MoveKnxObjectIndex, const byte StepKnxObjectIndex,
        const byte UpTriggerKnxObjectIndex, const byte DownTriggerKnxObjectIndex,
        const __FlashStringHelper* Name, NkkKey* Key, Delegate<bool>* CanActivate);
